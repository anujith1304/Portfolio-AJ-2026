...
export function Hero() {
  return (
    <section className="relative w-full overflow-hidden pt-[104px] pb-[56px] xl:h-[calc(742*var(--u))] xl:w-[calc(1904*var(--u))] xl:overflow-visible xl:pt-0 xl:pb-0">
      <div className="xl:absolute xl:inset-0">
        ...
        <Image
          ...
          height={742}
          priority
          className="absolute left-1/2 top-0 h-full w-screen max-w-none -translate-x-1/2 object-cover xl:h-[calc(742*var(--u))] xl:min-w-[calc(1904*var(--u))]"
        />
        ...
        */}
        <div className="fixed left-1/2 top-[16px] z-50 w-[min(452px,calc(100vw-32px))] -translate-x-1/2 xl:left-[calc(50%-223px)] xl:top-[calc(35*var(--u))] xl:w-auto xl:translate-x-0">
          <Nav />
        </div>

        {/* Heading + buttons — 5826:24092 at (509,207), 885x344, gap 40 */}
        <div className="page-x relative flex w-full flex-col items-center gap-[28px] xl:absolute xl:left-[calc(509*var(--u))] xl:top-[calc(207*var(--u))] xl:w-[calc(885*var(--u))] xl:gap-[calc(40*var(--u))]">
          {/* 5826:24093 — gap 20 */}
          <div className="flex w-full flex-col items-center gap-[16px] xl:gap-[calc(20*var(--u))]">
            {/*
            ...
            */}
            <h1 className="type-hero w-full text-center xl:w-[calc(885*var(--u))]">
            ...
            <p className="type-bio-24 measure w-full text-center text-black/50 xl:w-[calc(887*var(--u))] xl:max-w-none">
          ...
          <div className="flex w-full max-w-[360px] items-center gap-[12px] xl:h-[calc(48*var(--u))] xl:w-auto xl:max-w-none xl:gap-[calc(16*var(--u))] xl:max-w-[calc(360*var(--u))]">
            <a
              href="#contact"
              className="relative flex h-[48px] w-full flex-1 items-center justify-center rounded-[14px] bg-[#121212] xl:w-[calc(164*var(--u))] xl:flex-none xl:h-[calc(48*var(--u))] xl:rounded-[calc(14*var(--u))]"
              style={{
                boxShadow:
        ...
        <div className="page-x mt-[40px] w-full xl:absolute xl:left-[calc(52*var(--u))] xl:top-[calc(674*var(--u))] xl:mt-0 xl:w-auto">
          <StatusBar />
        </div>
      </div>
    </section>
